export const capabilities = [
  ...
  },
  {
    ...
    text: 'Professional AI-powered business websites, e-commerce platforms, landing pages, portfolio websites, and fast Progressive Web Apps.',
    tags: ['E-commerce', 'PWA', 'Websites'],
    accent: 'web',
  },
  {
    title: 'Mobile App Development',
    text: 'AI-powered Android, iOS, React Native, Flutter, and on-demand mobile applications designed for seamless user experiences.',
    tags: ['Android', 'iOS', 'Flutter'],
    accent: 'mobile',
  },
  {
    title: 'Cloud & DevOps',
    text: 'AI-powered cloud hosting, server deployment, CI/CD pipelines, database management, scalable architecture, and reliable infrastructure setup.',
    tags: ['Cloud', 'CI/CD', 'Infrastructure'],
    accent: 'cloud',
  },
  {
    title: 'Cybersecurity',
    text: 'AI-driven cybersecurity solutions, security audits, penetration testing, data protection, network security, continuous monitoring, and stronger digital defense systems.',
    tags: ['Audits', 'Pentesting', 'Defense'],
    accent: 'security',
  },
  {
    title: 'Data & Analytics',
    text: 'AI-powered business dashboards, predictive analytics, intelligent reporting systems, interactive data visualization, and large-scale data processing.',
    tags: ['Dashboards', 'Analytics', 'Data'],
    accent: 'ai',
  },
  {
    title: 'Automation Services',
    text: 'AI-powered business process automation, intelligent workflow automation, CRM automation, AI-driven lead generation, email automation, and SMS automation.',
    tags: ['Workflows', 'CRM', 'Lead Gen'],
    accent: 'software',
  },
  {
    title: 'Digital Marketing',
    text: 'AI-powered SEO, performance marketing, social media campaigns, AI-assisted content strategy, conversion optimization, and analytics-driven growth systems.',
...
export const aboutCapabilityChips = [
